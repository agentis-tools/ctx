...
Semantic mode requires a compatible embedding corpus. If embeddings are missing,
or were generated by another provider/dimension, the command exits 2 and tells
