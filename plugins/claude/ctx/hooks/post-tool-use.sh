...
# ctx:checksum sha256:166ba72551b2eea8b9866c5ca5ef60f52afbcf0a94a5d21116d8dbf639f62624
...
if [ "$compat_status" -eq 3 ]; then
    echo "ctx hooks: installed ctx is older than these hook templates (need 0.3.4); skipping post-tool-use action. Update ctx, then rerun 'ctx harness init'." >&2
    exit 0
