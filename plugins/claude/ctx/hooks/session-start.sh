...
# ctx:checksum sha256:2f8ba57716fbc60575a17301302ed2ae8dcadf2338158a4a9fe46f150a5967aa
...
ctx harness compat --require "0.3.4"
compat_status=$?
if [ "$compat_status" -eq 3 ]; then
    echo "ctx hooks: installed ctx is older than these hook templates (need 0.3.4); skipping session-start action. Update ctx, then rerun 'ctx harness init'." >&2
    exit 0
