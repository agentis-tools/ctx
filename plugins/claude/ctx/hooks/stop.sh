...
# ctx:checksum sha256:fa5febf938fe39f9281ca1a1ac5da95c037d2ee19b8b8b7b8d6be297527cd4ea
...
if [ "$compat_status" -eq 3 ]; then
    echo "ctx hooks: installed ctx is older than these hook templates (need 0.3.4); skipping stop action. Update ctx, then rerun 'ctx harness init'." >&2
    exit 0
